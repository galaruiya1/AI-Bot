...
不要改 `connector_name` 就接到 AstralX。Hummingbot 没有该交易所 connector。AstralX 线上是 `www.astralx.com/openapi/`，**不是** Websea 的 `oapi.websea.com`。详见 [AstralX 可行性](../../docs/astralx-feasibility.md)。
